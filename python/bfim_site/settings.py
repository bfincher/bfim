...
SECRET_KEY = ')%1x0+_j^0j^(6p#8rqg$yzk_0%a*$-q--e#rvw4e7h!5i5y$x'
...
ROOT_URLCONF = 'bfim_site.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bfim_site.wsgi.application'
